...
class PongEnv:
    ...
    def reset(self):
        ...
        self.ball_dx, self.ball_dy = np.random.choice([-3, 3]), np.random.choice([-3, 3])
    ...
    def step(self, action):
        ...
        if self.ball_y >= self.height - self.paddle_height and self.paddle_x < self.ball_x < self.paddle_x + self.paddle_width:
            self.ball_dy*= -1
            reward = 1
